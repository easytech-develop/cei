...
import { createCashAccount } from "../../../server/cash-accounts";
import type { CashAccountResponse } from "../../../types/cash-accounts";

type CreateCashAccountProps = {
...
export default function CreateCashAccount({
  trigger,
  onSuccess,
}: CreateCashAccountProps) {
  const [open, setOpen] = useState(false);
  const [isSubmitting, setIsSubmitting] = useState(false);

  const form = useForm<CreateCashAccountSchema>({
    defaultValues: {
      name: "",
      type: "CHECKING",
      agency: "",
  ...
  async function onSubmit(data: CreateCashAccountSchema) {
    setIsSubmitting(true);
    const response = await createCashAccount(data);
